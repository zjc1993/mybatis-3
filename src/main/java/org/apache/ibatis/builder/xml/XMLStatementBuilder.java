...
public class XMLStatementBuilder extends BaseBuilder {
	 ...
	 * 
	 * 取出节点信息，封装成为一个MappedStatement对象。
	 * 例如
	 ...
	 * </select>
	 * 
	 * 这个语句封装成一个MappedStatement并且把它放入configuration对象中的mappedStatements变量中。
	 * 这是一个HashMap。key是这个MappedStatement的ID（namespace+标签中的ID值）。value是整个MappedStatement
	 */
