...
public class XMLMapperBuilder extends BaseBuilder {
	...
	/**
	 * 解析myabtis配置文件中的Mapper元素，配置文件中有多少个Mapper文件就解析多少次
	 */
	public void parse() {
		...
		//解析在configurationElement方法中未完成的<resultMap />节点
		parsePendingResultMaps();
		//解析在configurationElement方法中未完成的<cache-ref />节点
		parsePendingCacheRefs();
		//解析在configurationElement方法中未完成的Sql语句节点
	...
	/**
	 * 解析Mapper XML中的各项元素并且把它放入configuration对象中
	 * @param context Mapper配置文件的所有内容
	 */
	...
	/**
	 * 使用接口开发的时候使用，将namespace+ID的值和对应的接口绑定。注册到configuration对象中的MapperRegistry中
	 */
